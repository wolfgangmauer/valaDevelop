/* source_create_file_dialog.c generated by valac 0.44.0, the Vala compiler
...
static gboolean _vala_develop_source_create_file_OnGroupSelected_gtk_tree_selection_func (GtkTreeSelection* selection,
                                                                                   ...
                                                                                   gboolean path_currently_selected,
                                                                                   gpointer self);
static void __lambda72_ (valaDevelopSourceCreateFile* self);
...
static void
__lambda72_ (valaDevelopSourceCreateFile* self)
{
	GtkButton* _tmp0_;
	GtkEntry* _tmp1_;
	const gchar* _tmp2_;
                                           ...
                                           GtkTreeIter* iter)
{
	...
	_tmp3_ = _g_object_ref0 (treeStore);
	_g_object_unref0 (self->priv->_overviewTreeStore);
	self->priv->_overviewTreeStore = _tmp3_;
	_tmp4_ = *iter;
	self->priv->_overviewTreeIter = _tmp4_;
	_tmp5_ = g_new0 (GType, 1);
	_tmp5_[0] = G_TYPE_STRING;
	_tmp6_ = _tmp5_;
	_tmp6__length1 = 1;
	_tmp7_ = gtk_tree_store_newv (1, _tmp6_);
	_tmp8_ = _tmp7_;
	_tmp6_ = (g_free (_tmp6_), NULL);
	groupTreeStore = _tmp8_;
	_tmp9_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	g_object_ref_sink (_tmp9_);
	_tmp10_ = _tmp9_;
	_tmp11_ = gtk_tree_view_column_new_with_attributes (_ ("Template"), (GtkCellRenderer*) _tmp10_, "text", 0, NULL);
	...
	_tmp13_ = self->priv->sourceGroup;
	gtk_tree_view_append_column (_tmp13_, c);
	gtk_tree_store_append (groupTreeStore, &_tmp14_, NULL);
	treeIter = _tmp14_;
	_tmp15_ = treeIter;
	g_value_init (&_tmp16_, G_TYPE_STRING);
	g_value_set_string (&_tmp16_, _ ("General"));
	gtk_tree_store_set_value (groupTreeStore, &_tmp15_, 0, &_tmp16_);
	G_IS_VALUE (&_tmp16_) ? (g_value_unset (&_tmp16_), NULL) : NULL;
	_tmp17_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp18_, &_tmp17_);
	generalIter = _tmp18_;
	_tmp19_ = generalIter;
	g_value_init (&_tmp20_, G_TYPE_STRING);
	g_value_set_string (&_tmp20_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_class));
	gtk_tree_store_set_value (groupTreeStore, &_tmp19_, 0, &_tmp20_);
	G_IS_VALUE (&_tmp20_) ? (g_value_unset (&_tmp20_), NULL) : NULL;
	_tmp21_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp22_, &_tmp21_);
	generalIter = _tmp22_;
	_tmp23_ = generalIter;
	g_value_init (&_tmp24_, G_TYPE_STRING);
	g_value_set_string (&_tmp24_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_enum));
	gtk_tree_store_set_value (groupTreeStore, &_tmp23_, 0, &_tmp24_);
	G_IS_VALUE (&_tmp24_) ? (g_value_unset (&_tmp24_), NULL) : NULL;
	_tmp25_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp26_, &_tmp25_);
	generalIter = _tmp26_;
	_tmp27_ = generalIter;
	g_value_init (&_tmp28_, G_TYPE_STRING);
	g_value_set_string (&_tmp28_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_interface));
	gtk_tree_store_set_value (groupTreeStore, &_tmp27_, 0, &_tmp28_);
	G_IS_VALUE (&_tmp28_) ? (g_value_unset (&_tmp28_), NULL) : NULL;
	_tmp29_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp30_, &_tmp29_);
	generalIter = _tmp30_;
	_tmp31_ = generalIter;
	g_value_init (&_tmp32_, G_TYPE_STRING);
	g_value_set_string (&_tmp32_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_struct));
	gtk_tree_store_set_value (groupTreeStore, &_tmp31_, 0, &_tmp32_);
	G_IS_VALUE (&_tmp32_) ? (g_value_unset (&_tmp32_), NULL) : NULL;
	gtk_tree_store_append (groupTreeStore, &_tmp33_, NULL);
	treeIter = _tmp33_;
	_tmp34_ = treeIter;
	g_value_init (&_tmp35_, G_TYPE_STRING);
	g_value_set_string (&_tmp35_, "Gtk");
	gtk_tree_store_set_value (groupTreeStore, &_tmp34_, 0, &_tmp35_);
	G_IS_VALUE (&_tmp35_) ? (g_value_unset (&_tmp35_), NULL) : NULL;
	_tmp36_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp37_, &_tmp36_);
	gtkIter = _tmp37_;
	_tmp38_ = gtkIter;
	g_value_init (&_tmp39_, G_TYPE_STRING);
	g_value_set_string (&_tmp39_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_dialog));
	gtk_tree_store_set_value (groupTreeStore, &_tmp38_, 0, &_tmp39_);
	G_IS_VALUE (&_tmp39_) ? (g_value_unset (&_tmp39_), NULL) : NULL;
	_tmp40_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp41_, &_tmp40_);
	gtkIter = _tmp41_;
	_tmp42_ = gtkIter;
	g_value_init (&_tmp43_, G_TYPE_STRING);
	g_value_set_string (&_tmp43_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_widget));
	gtk_tree_store_set_value (groupTreeStore, &_tmp42_, 0, &_tmp43_);
	G_IS_VALUE (&_tmp43_) ? (g_value_unset (&_tmp43_), NULL) : NULL;
	_tmp44_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp45_, &_tmp44_);
	gtkIter = _tmp45_;
	_tmp46_ = gtkIter;
	g_value_init (&_tmp47_, G_TYPE_STRING);
	g_value_set_string (&_tmp47_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_window));
	gtk_tree_store_set_value (groupTreeStore, &_tmp46_, 0, &_tmp47_);
	G_IS_VALUE (&_tmp47_) ? (g_value_unset (&_tmp47_), NULL) : NULL;
	_tmp48_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp49_, &_tmp48_);
	gtkIter = _tmp49_;
	_tmp50_ = gtkIter;
	g_value_init (&_tmp51_, G_TYPE_STRING);
	g_value_set_string (&_tmp51_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_plugin));
	gtk_tree_store_set_value (groupTreeStore, &_tmp50_, 0, &_tmp51_);
	G_IS_VALUE (&_tmp51_) ? (g_value_unset (&_tmp51_), NULL) : NULL;
	gtk_tree_store_append (groupTreeStore, &_tmp52_, NULL);
	treeIter = _tmp52_;
	_tmp53_ = treeIter;
	g_value_init (&_tmp54_, G_TYPE_STRING);
	g_value_set_string (&_tmp54_, "Glade");
	gtk_tree_store_set_value (groupTreeStore, &_tmp53_, 0, &_tmp54_);
	G_IS_VALUE (&_tmp54_) ? (g_value_unset (&_tmp54_), NULL) : NULL;
	_tmp55_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp56_, &_tmp55_);
	gladeIter = _tmp56_;
	_tmp57_ = gladeIter;
	g_value_init (&_tmp58_, G_TYPE_STRING);
	g_value_set_string (&_tmp58_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_dialog_resource));
	gtk_tree_store_set_value (groupTreeStore, &_tmp57_, 0, &_tmp58_);
	G_IS_VALUE (&_tmp58_) ? (g_value_unset (&_tmp58_), NULL) : NULL;
	_tmp59_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp60_, &_tmp59_);
	gladeIter = _tmp60_;
	_tmp61_ = gladeIter;
	g_value_init (&_tmp62_, G_TYPE_STRING);
	g_value_set_string (&_tmp62_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_widget_resource));
	gtk_tree_store_set_value (groupTreeStore, &_tmp61_, 0, &_tmp62_);
	G_IS_VALUE (&_tmp62_) ? (g_value_unset (&_tmp62_), NULL) : NULL;
	_tmp63_ = treeIter;
	gtk_tree_store_append (groupTreeStore, &_tmp64_, &_tmp63_);
	gladeIter = _tmp64_;
	_tmp65_ = gladeIter;
	g_value_init (&_tmp66_, G_TYPE_STRING);
	g_value_set_string (&_tmp66_, _ (VALA_DEVELOP_SOURCE_CREATE_FILE_empty_window_resource));
	gtk_tree_store_set_value (groupTreeStore, &_tmp65_, 0, &_tmp66_);
	G_IS_VALUE (&_tmp66_) ? (g_value_unset (&_tmp66_), NULL) : NULL;
	_tmp67_ = self->priv->sourceGroup;
	gtk_tree_view_set_model (_tmp67_, (GtkTreeModel*) groupTreeStore);
	_tmp68_ = self->priv->sourceGroup;
	gtk_tree_view_columns_autosize (_tmp68_);
	_tmp69_ = self->priv->sourceGroup;
	gtk_tree_view_expand_all (_tmp69_);
	_tmp70_ = self->priv->sourceGroup;
	_tmp71_ = gtk_tree_view_get_selection (_tmp70_);
	gtk_tree_selection_set_select_function (_tmp71_, _vala_develop_source_create_file_OnGroupSelected_gtk_tree_selection_func, g_object_ref (self), g_object_unref);
	_tmp72_ = self->priv->sourceName;
	g_signal_connect_object ((GtkEditable*) _tmp72_, "changed", (GCallback) ___lambda72__gtk_editable_changed, self, 0);
...
vala_develop_source_create_file_new (GtkWidget* parent,
                                     ...
                                     GtkTreeIter* iter)
{
	return vala_develop_source_create_file_construct (VALA_DEVELOP_TYPE_SOURCE_CREATE_FILE, parent, treeStore, iter);
}
                                                ...
                                                gint r)
{
	...
	g_return_if_fail (self != NULL);
	{
		...
		solutionIter = _tmp1_;
		_tmp2_ = self->priv->_overviewTreeStore;
		_tmp3_ = solutionIter;
		...
		_tmp75_ = self->priv->_overviewTreeStore;
		...
		tmpIter = _tmp80_;
		_g_free0 (_tmp79_);
		_tmp81_ = self->priv->_overviewTreeStore;
		_tmp82_ = tmpIter;
		...
		_tmp86_ = self->priv->_overviewTreeStore;
		_tmp87_ = tmpIter;
                                              ...
                                              gint c)
{
	...
	g_return_if_fail (self != NULL);
	{
		...
		_tmp88_ = self->priv->_overviewTreeStore;
		_tmp89_ = tmpIter;
		...
		_tmp92_ = self->priv->_overviewTreeStore;
		_tmp93_ = tmpIter;
