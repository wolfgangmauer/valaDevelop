/* new_folder.c generated by valac 0.44.0, the Vala compiler
...
valaDevelopNewFolder* vala_develop_new_folder_construct (GType object_type,
                                                         ...
                                                         valaDevelopOverviewTreeStore* treeStore,
                                                         GtkTreeIter* iter);
static void __lambda73_ (valaDevelopNewFolder* self);
...
static void
__lambda73_ (valaDevelopNewFolder* self)
{
	GtkButton* _tmp0_;
	GtkEntry* _tmp1_;
	const gchar* _tmp2_;
                                   ...
                                   GtkTreeIter* iter)
{
	...
	_tmp3_ = self->priv->folderName;
	g_signal_connect_object ((GtkEditable*) _tmp3_, "changed", (GCallback) ___lambda73__gtk_editable_changed, self, 0);
	gtk_widget_show_all ((GtkWidget*) self);
	_tmp4_ = self->priv->create;
	gtk_widget_set_can_default ((GtkWidget*) _tmp4_, TRUE);
	_tmp5_ = self->priv->create;
	g_object_set ((GtkWidget*) _tmp5_, "has-default", TRUE, NULL);
	return self;
}
...
vala_develop_new_folder_new (GtkWidget* parent,
                             ...
                             GtkTreeIter* iter)
{
	return vala_develop_new_folder_construct (VALA_DEVELOP_TYPE_NEW_FOLDER, parent, treeStore, iter);
}
...
vala_develop_new_folder_OnAccept (valaDevelopNewFolder* self)
{
	...
	g_return_if_fail (self != NULL);
	{
		...
		_tmp20_ = self->priv->_overviewTreeStore;
		_tmp21_ = newIter;
