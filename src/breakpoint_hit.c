...
static void ___lambda27_ (Block8Data* _data8_,
                   JsonArray* array,
                   guint index_,
                   JsonNode* element);
GList* vala_develop_breakpoint_get_thread_groups (valaDevelopBreakpoint* self);
static void ____lambda27__json_array_foreach (JsonArray* array,
                                       guint index_,
                                       JsonNode* element_node,
                                       gpointer self);
static void ___lambda26__json_object_foreach (JsonObject* object,
                                       const gchar* member_name,
                                       JsonNode* member_node,
                                       gpointer self);
...
static void
___lambda27_ (Block8Data* _data8_,
              JsonArray* array,
              guint index_,
              JsonNode* element)
{
...
static void
____lambda27__json_array_foreach (JsonArray* array,
                                  guint index_,
                                  JsonNode* element_node,
                                  gpointer self)
{
...
#line 252 "/home/wolfgang/Projekte/vDevelop/valaDevelop/breakpoint_hit.vala"
				json_array_foreach_element (_tmp26_, ____lambda27__json_array_foreach, _data8_);
...
static void
___lambda26__json_object_foreach (JsonObject* object,
                                  const gchar* member_name,
                                  JsonNode* member_node,
                                  gpointer self)
{
#line 213 "/home/wolfgang/Projekte/vDevelop/valaDevelop/breakpoint_hit.vala"
	__lambda26_ (self, object, member_name, member_node);
...
#line 213 "/home/wolfgang/Projekte/vDevelop/valaDevelop/breakpoint_hit.vala"
	json_object_foreach_member (obj, ___lambda26__json_object_foreach, _data8_);
