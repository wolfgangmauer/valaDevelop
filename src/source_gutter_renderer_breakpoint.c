...
static void _____lambda30_ (valaDevelopSourceGutterRendererBreakPoint* self,
                     GtkWidget* widget);
static void ______lambda30__gtk_callback (GtkWidget* widget,
                                   gpointer self);
...
static void
_____lambda30_ (valaDevelopSourceGutterRendererBreakPoint* self,
                GtkWidget* widget)
{
	GtkMenu* _tmp0_;
...
static void
______lambda30__gtk_callback (GtkWidget* widget,
                              gpointer self)
{
#line 67 "/home/wolfgang/Projekte/vDevelop/valaDevelop/SourceGutter/source_gutter_renderer_breakpoint.vala"
	_____lambda30_ ((valaDevelopSourceGutterRendererBreakPoint*) self, widget);
...
#line 67 "/home/wolfgang/Projekte/vDevelop/valaDevelop/SourceGutter/source_gutter_renderer_breakpoint.vala"
				gtk_container_foreach ((GtkContainer*) _tmp10_, ______lambda30__gtk_callback, self);
