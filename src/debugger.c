...
static gboolean __lambda70_ (valaDevelopDebugger* self);
...
valaDevelopDebuggerSymbols* vala_develop_debugger_symbols_construct (GType object_type,
                                                                     ...
                                                                     const gchar* projectIterName);
static gboolean __lambda71_ (Block11Data* _data11_,
                      GtkTreeModel* tmpModel,
                      GtkTreePath* path,
                      GtkTreeIter* iter);
static gboolean ___lambda71__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                                   GtkTreePath* path,
                                                   GtkTreeIter* iter,
                                                   gpointer self);
...
static gboolean ____lambda69_ (Block13Data* _data13_,
                        GtkTreeModel* tmpModel,
                        GtkTreePath* path,
                        GtkTreeIter* iter);
...
static gboolean _____lambda69__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                                     GtkTreePath* path,
                                                     GtkTreeIter* iter,
                                                     gpointer self);
...
static gboolean ___lambda65_ (Block14Data* _data14_);
...
static gboolean __lambda61_ (Block15Data* _data15_,
                      GtkTreeModel* tmpModel,
                      GtkTreePath* path,
                      GtkTreeIter* iter);
...
void vala_develop_source_gutter_renderer_break_point_move (valaDevelopSourceGutterRendererBreakPoint* self,
                                                           ...
                                                           gint newLine,
                                                           gboolean redraw);
static gboolean ___lambda61__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                                   GtkTreePath* path,
                                                   GtkTreeIter* iter,
                                                   gpointer self);
static gboolean ____lambda63_ (Block15Data* _data15_);
static gboolean _____lambda63__gsource_func (gpointer self);
...
static gboolean _____lambda59_ (Block17Data* _data17_);
static gboolean ______lambda59__gsource_func (gpointer self);
...
static gboolean
__lambda71_ (Block11Data* _data11_,
             GtkTreeModel* tmpModel,
             GtkTreePath* path,
             GtkTreeIter* iter)
{
...
static gboolean
___lambda71__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                          GtkTreePath* path,
                                          GtkTreeIter* iter,
                                          gpointer self)
{
...
static gboolean
____lambda69_ (Block13Data* _data13_,
               GtkTreeModel* tmpModel,
               GtkTreePath* path,
               GtkTreeIter* iter)
{
...
static gboolean
_____lambda69__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                            GtkTreePath* path,
                                            GtkTreeIter* iter,
                                            gpointer self)
{
...
static gboolean
___lambda65_ (Block14Data* _data14_)
{
	valaDevelopDebugger* self;
	gboolean result = FALSE;
...
static gboolean
__lambda61_ (Block15Data* _data15_,
             GtkTreeModel* tmpModel,
             GtkTreePath* path,
             GtkTreeIter* iter)
{
...
static gboolean
___lambda61__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                          GtkTreePath* path,
                                          GtkTreeIter* iter,
                                          gpointer self)
{
...
static gboolean
____lambda63_ (Block15Data* _data15_)
{
	valaDevelopDebugger* self;
	gboolean result = FALSE;
	valaDevelopStackFrame* _tmp0_;
...
static gboolean
_____lambda63__gsource_func (gpointer self)
{
	gboolean result;
...
static gboolean
_____lambda59_ (Block17Data* _data17_)
{
	Block16Data* _data16_;
	valaDevelopDebugger* self;
	gboolean result = FALSE;
...
static gboolean
______lambda59__gsource_func (gpointer self)
{
	gboolean result;
