...
static void ___lambda86__gtk_widget_hide (GtkWidget* _sender,
                                   gpointer self);
static void __lambda87_ (valaDevelopSearchAndReplace* self,
                  GObject* sender,
                  GParamSpec* property);
...
static void _vala_develop_search_and_replace_OnTextChanged_gtk_editable_changed (GtkEditable* _sender,
                                                                          gpointer self);
static void __lambda88_ (valaDevelopSearchAndReplace* self,
                  GObject* source_object,
                  GAsyncResult* res);
static Block2Data* block2_data_ref (Block2Data* _data2_);
static void block2_data_unref (void * _userdata_);
static gboolean ___lambda89_ (Block2Data* _data2_);
static gboolean ____lambda89__gsource_func (gpointer self);
static void ___lambda88__gasync_ready_callback (GObject* source_object,
                                         GAsyncResult* res,
                                         gpointer self);
...
static void
__lambda87_ (valaDevelopSearchAndReplace* self,
             GObject* sender,
             GParamSpec* property)
{
	const gchar* _tmp0_;
...
static gboolean
___lambda89_ (Block2Data* _data2_)
{
	valaDevelopSearchAndReplace* self;
	gboolean result = FALSE;
	GtkSourceView* _tmp0_;
...
static void
__lambda88_ (valaDevelopSearchAndReplace* self,
             GObject* source_object,
             GAsyncResult* res)
{
	Block2Data* _data2_;
...
static void
___lambda88__gasync_ready_callback (GObject* source_object,
                                    GAsyncResult* res,
                                    gpointer self)
{
